...
<html style="font-size: 16px;"> <!-- APERTURA HTML -->
  ...
  <head> <!-- APERTURA HEAD -->
    ...
    <meta name="keywords" content="​Famous Fashion Photographers"> <!-- METAPROGRAMACIÓN -->
	...
	<link rel="stylesheet" href="Principal.css" media="screen"> <!-- ESTILOS EN CASCADA CSS -->
    ...
    <link id="u-page-google-font" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Oswald:200,300,400,500,600,700"> <!-- ESTILOS EN CASCADA CSS -->
    ...
    <meta name="twitter:title" content="Principal"> <!-- METAPROGRAMACIÓN -->
    <meta name="twitter:description" content=""> <!-- METAPROGRAMACIÓN -->
    <meta property="og:title" content="Principal"> <!-- METAPROGRAMACIÓN -->
  ...
  <div class="u-section-rows"> <!-- APERTURA 1º DIV HEADER -->
    ...
    <section class="u-clearfix u-section-1" id="carousel_a077"> <!-- APERTURA 1º SECTION -->
	
      <div class="u-clearfix u-sheet u-sheet-1"> <!-- APERTURA 1º DIV DEL 1º SECTION -->
	  
        <div class="u-grey-75 u-shape u-shape-rectangle u-shape-1"></div> <!-- APERTURA Y CIERRE 2º DIV DEL 1º SECTION -->
		
        <div class="u-clearfix u-expanded-width u-gutter-24 u-layout-wrap u-layout-wrap-1"> <!-- APERTURA 3º DIV DEL 1º SECTION -->
		 
          <div class="u-gutter-0 u-layout"> <!-- APERTURA 4º DIV DEL 1º SECTION -->
		  
            <div class="u-layout-row"> <!-- APERTURA 5º DIV DEL 1º SECTION -->
			
              <div class="u-size-30"> <!-- APERTURA 6º DIV DEL 1º SECTION -->
			  
                <div class="u-layout-col"> <!-- APERTURA 7º DIV DEL 1º SECTION -->
				
                  <div class="u-container-style u-image u-layout-cell u-size-60 u-image-1" data-image-width="1200" data-image-height="1773"> <!-- APERTURA 8º DIV DEL 1º SECTION -->
				  
                    <div class="u-container-layout u-container-layout-1"></div> <!-- APERTURA Y CIERRE 9º DIV DEL 1º SECTION -->
					
                  </div> <!-- CIERRE 8º DIV DEL 1º SECTION -->
				  
                </div> <!-- CIERRE 7º DIV DEL 1º SECTION -->
				
              </div> <!-- CIERRE 6º DIV DEL 1º SECTION -->
			  
              <div class="u-size-30"> <!-- APERTURA 10º DIV DEL 1º SECTION -->
			  
                <div class="u-layout-col"> <!-- APERTURA 11º DIV DEL 1º SECTION -->
				
                  <div class="u-align-left u-container-style u-layout-cell u-size-30 u-layout-cell-2"> <!-- APERTURA 12º DIV DEL 1º SECTION -->
				  
                    <div class="u-container-layout u-valign-middle u-container-layout-2"> <!-- APERTURA 13º DIV DEL 1º SECTION -->
					
                      <h2 class="u-custom-font u-font-oswald u-text u-text-white u-text-1"> LOS HIJOS DE MIL DE ESPAÑA ¿LEYENDA O REALIDAD?</h2>
					  
                    </div> <!-- CIERRE 13º DIV DEL 1º SECTION -->
					
                  </div> <!-- CIERRE 12º DIV DEL 1º SECTION -->
				  
                  <div class="u-container-style u-layout-cell u-size-30 u-white u-layout-cell-3"> <!-- APERTURA 14º DIV DEL 1º SECTION -->
				  
                    <div class="u-container-layout u-container-layout-3"> <!-- APERTURA 15º DIV DEL 1º SECTION -->
					
                      <p class="u-text u-text-2"> El Libro de las Invasiones de Irlanda nos narra las sucesivas invasiones que sufrio la isla hasta la llegada desde España de los hijos de Mil, antecesores de los irlandeses actuales. Pero ¿existieron estos hijos de Mil?</p>
					  
                      <a href="https://es.wikipedia.org/wiki/Milesianos"  target="_blank" class="u-active-palette-4-light-2 u-border-none u-btn u-button-style u-hover-palette-4-light-2 u-palette-4-base u-btn-1">Saber más</a>
					  
                    </div> <!-- CIERRE 15º DIV DEL 1º SECTION -->
					
                  </div> <!-- CIERRE 14º DIV DEL 1º SECTION -->
				  
                </div> <!-- CIERRE 11º DIV DEL 1º SECTION -->
				
              </div> <!-- CIERRE 10º DIV DEL 1º SECTION -->
			  
            </div> <!-- CIERRE 5º DIV DEL 1º SECTION -->
			
          </div> <!-- CIERRE 4º DIV DEL 1º SECTION -->
		  
        </div> <!-- CIERRE 3º DIV DEL 1º SECTION -->
		
        <p class="u-text u-text-default u-text-white u-text-3">&nbsp;<b>Míl Espáine</b>&nbsp;(del&nbsp;Latín&nbsp;<i>Miles Hispaniae</i>, Soldado de&nbsp;Hispania) </p>
		
      </div> <!-- CIERRE 1º DIV DEL 1º SECTION -->
	  	  
    </section> <!-- CIERRE 1º SECTION -->  
	
	
    <section class="u-clearfix u-grey-10 u-section-2" id="sec-c20a"> <!-- APERTURA 2º SECTION -->
	
      <div class="u-clearfix u-sheet u-sheet-1"> <!-- APERTURA 1º DIV DEL 2º SECTION -->
	  
        <div class="u-clearfix u-expanded-width u-gutter-18 u-layout-wrap u-layout-wrap-1"> <!-- APERTURA 2º DIV DEL 2º SECTION -->
		
          <div class="u-gutter-0 u-layout"> <!-- APERTURA 3º DIV DEL 2º SECTION -->
		  
            <div class="u-layout-row"> <!-- APERTURA 4º DIV DEL 2º SECTION -->
			
              <div class="u-size-30 u-size-60-md"> <!-- APERTURA 5º DIV DEL 2º SECTION -->
			  
                <div class="u-layout-row"> <!-- APERTURA 6º DIV DEL 2º SECTION -->
				
                  <div class="u-align-left u-container-style u-image u-layout-cell u-left-cell u-size-60 u-image-1" src="" data-image-width="946" data-image-height="1360"> <!-- APERTURA 7º DIV DEL 2º SECTION -->
				  
                    <div class="u-container-layout u-valign-middle u-container-layout-1" src=""></div> <!-- APERTURA Y CIERRE 8º DIV DEL 2º SECTION -->
					
                  </div> <!-- CIERRE 7º DIV DEL 2º SECTION -->
				  
                </div> <!-- CIERRE 6º DIV DEL 2º SECTION -->
				
              </div> <!-- CIERRE 5º DIV DEL 2º SECTION -->
			  
              <div class="u-size-30 u-size-60-md"> <!-- APERTURA 9º DIV DEL 2º SECTION -->
			  
                <div class="u-layout-col"> <!-- APERTURA 10º DIV DEL 2º SECTION -->
				
                  <div class="u-align-left u-container-style u-image u-layout-cell u-right-cell u-size-40 u-image-2" data-image-width="499" data-image-height="311"> <!-- APERTURA 11º DIV DEL 2º SECTION -->
				  
                    <div class="u-container-layout u-container-layout-2" src=""></div> <!-- APERTURA Y CIERRE 12º DIV DEL 2º SECTION -->
					
                  </div> <!-- CIERRE 11º DIV DEL 2º SECTION -->
				  
                  <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-20 u-white u-layout-cell-3" src=""> <!-- APERTURA 13º DIV DEL 2º SECTION -->
				  
                    <div class="u-container-layout u-container-layout-3"> <!-- APERTURA 14º DIV DEL 2º SECTION -->
					
                      <h2 class="u-text u-text-1"> <!-- APERTURA DEL H2 EN EL 14º DIV DEL 2º SECTION -->
					  
                        <span style="font-size: 1.875rem;">LA LEYENDA DEL LEBOR GABBALA</span>
						
                      </h2> <!-- CIERRE DEL H2 EN EL 14º DIV DEL 2º SECTION -->
					  
                      <p class="u-text u-text-2"> La leyenda nos habla de una tribu, los Gaedil, asentados en el Este de Europa, en Escitia, junto al Mar Negro. Alentados por una profecía del druida Caicher y por la promesa que Moisés hizo a su antepasado Gaedil Glass de una tierra para todos, sus miembros inician una migración hacia el Oeste, encabezados por Brath.</p>
					  
                      <a href="https://gl.wikipedia.org/wiki/Lebor_Gab%C3%A1la_%C3%89renn"  target="_blank" class="u-active-palette-4-light-2 u-border-none u-btn u-button-style u-hover-palette-4-light-2 u-palette-4-base u-btn-2">Saber más</a>
					  
                    </div> <!-- CIERRE 14º DIV DEL 2º SECTION -->
					
                  </div> <!-- CIERRE 13º DIV DEL 2º SECTION -->
				  
                </div> <!-- CIERRE 10º DIV DEL 2º SECTION -->
				
              </div> <!-- CIERRE 9º DIV DEL 2º SECTION -->
			  
            </div> <!-- CIERRE 4º DIV DEL 2º SECTION -->
			
          </div> <!-- CIERRE 3º DIV DEL 2º SECTION -->
		  
        </div> <!-- CIERRE 2º DIV DEL 2º SECTION -->
		
      </div> <!-- CIERRE 1º DIV DEL 2º SECTION -->
	  
    </section> <!-- CIERRE 2º SECTION -->
	
	
    <section class="u-align-center-md u-align-center-sm u-align-center-xs u-clearfix u-image u-valign-top u-section-3" id="carousel_def0" data-image-width="972" data-image-height="720"> <!-- APERTURA 3º SECTION -->
	
      <div class="u-container-style u-group u-opacity u-opacity-45 u-palette-4-light-3 u-group-1"> <!-- APERTURA 1º DIV DEL 3º SECTION -->
	  
        <div class="u-container-layout u-container-layout-1"> <!-- APERTURA 2º DIV DEL 3º SECTION -->
		
          <h4 class="u-align-justify u-text u-text-body-alt-color u-text-1"> <!-- APERTURA DEL H4 EN EL 2º DIV DEL 3º SECTION -->
		  
            <span style="font-size: 1.875rem;">LA LEYENDA DEL 
			
				<span class="u-text-black">' LEBOR GABBALA '</span>
				
            </span>
			
          </h4> <!-- CIERRE DEL H4 EN EL 2º DIV DEL 3º SECTION -->
		  
          <p class="u-align-justify u-text u-text-2"> La leyenda nos habla de una tribu, los Gaedil, asentados en el Este de Europa, en Escitia, junto al Mar Negro. Alentados por una profecía del druida Caicher y por la promesa que Moisés hizo a su antepasado Gaedil Glass de una tierra para todos, sus miembros inician una migración hacia el Oeste, encabezados por Brath. Llegan finalmente a la peninsula Iberica, donde se asientan por un tiempo. El hijo de Brath, Breogan, gran guerrero, conseguira someter definitivamente a los antiguos pobladores y funda la ciudad de B​rigantia (la actual Coruña), edificando una torre, ​Tor Breoghain, la Torre de Hercules.<br>(Denonimada como Torre de Hércules al ser reedificada por los romanos a finales de siglo primero&nbsp; después de Cristo)<span class="u-text-palette-3-dark-1"><br>Es el faro más antiguo del mundo en funcionamiento. </span> </p>
			  
        </div> <!-- CIERRE 2º DIV DEL 3º SECTION -->
		
      </div> <!-- CIERRE 1º DIV DEL 3º SECTION -->
	  
    </section> <!-- CIERRE 3º SECTION -->
