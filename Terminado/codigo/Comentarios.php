  ...
  <div class="u-section-rows"> <!-- APERTURA 1º DIV HEADER -->
        ...
        <div class="u-align-center-xs u-section-row u-section-row-2" id="sec-71fa"> <!-- APERTURA 5º DIV HEADER -->
          ...
          <div class="u-clearfix u-sheet u-valign-middle-xs u-sheet-2"> <!-- APERTURA 6º DIV HEADER -->
			...
			<h1 class="u-align-left u-text u-text-1"> Has iniciado sesión como <?php echo $user ?>, dinos, ¿Qué opinas?. </h1>
			
			<p> <a href="Consultar_Comentarios.php" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-1"> Consultar Comentarios </a> </p>
    ...
    <section class="u-clearfix u-section-1" id="carousel_a077">
					...
					<fieldset style="background-color:#FFF0F5;margin: 0 auto; width: 950px; height: 450px ; border:2px solid black;color:#8B0000;">
						
						<legend class="u-small-text u-text u-text-variant u-text-1" style="text-align:center;"> Comentarios </legend>
						
							<form action="Comentario_Usuario.php" method="post">
							
								<label> 
																			
									<textarea style="resize: none;" name="Texto" rows="8" cols="80"> Escriba aquí su opinión. </textarea>
									
								</label>
		
						<!-- Primero debes de crear un input que no se vea; estos son los de tipo hidden.Esto hace que
						puedas crear un input que no se vea y tenga el name de usuario para poder usarlo en la otra pagina.En
						la siguiente pagina necesitas rescatar el valor de usuario para, a raíz de él, sacar su id, por ello se crea este input
						invisible que ademas no afecta a la estetica. El value, al ser un echo de user siempre valdrá lo que valga esa variable -->
